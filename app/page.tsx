            ...
            <div className="flex flex-col items-center space-y-8 text-center">
              <div className="space-y-6">
                ...
                <p className="mx-auto max-w-[700px] text-xl sm:text-2xl md:text-3xl text-primary-foreground/90 dark:text-gray-200 px-4 font-light leading-relaxed">
                  A notary&apos;s word is as good as <ShimmerText className="font-semibold">gold</ShimmerText>
                </p>
              </div>
        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          <FadeIn>
            <div className="text-center space-y-3 mb-10 sm:mb-12 px-2 sm:px-0">
              ...
              As an experienced Notary Public, I provide prompt, efficient, and effective legal services in specialized areas of law. My priority is guiding clients through legal requirements while protecting their interests.
              </p>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="flex flex-col items-center space-y-6 text-center">
              ...
              <p className="mx-auto max-w-[600px] text-base sm:text-lg text-primary-foreground/90 px-4">
                For every milestone, Chelsea Kramer Notary Public can help. Contact us today to book your appointment.
              </p>
